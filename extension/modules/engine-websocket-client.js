// engine-websocket-client.js - WebSocket Client for unobs.py Backend
class EngineWebSocketClient {
    ...
    _handleMessage(data) {
        ...
        // Analysis info:  "info depth 15 score cp 125 pv e2e4 e7e5..."
        ...
        // Engine options (for settings UI)
    ...
    _parseOption(line) {
        // Parse:  "option name Hash type spin default 16 min 1 max 131072"
